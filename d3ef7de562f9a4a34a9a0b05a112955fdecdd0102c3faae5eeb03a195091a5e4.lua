...
local function s()
    ...
    while wait() do
        if game.Players.LocalPlayer.PlayerGui["All-InBackpackDisplayHolder"].MainHolder.Denominator.Text == "10" then
            local bagnumer = 0.2 * game.Players.LocalPlayer.PlayerGui["All-InBackpackDisplayHolder"].MainHolder.Numerator.Text - game.Players.LocalPlayer.PlayerGui["All-InBackpackDisplayHolder"].MainHolder.Numerator.Text
	    if bagnumer < 0 then
	        local bagnumer = 0
	    end
	    o.Parent.Text =
